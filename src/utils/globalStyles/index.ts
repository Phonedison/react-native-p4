export const whiteColor: string = "rgba(255, 255, 255,1)";
export const backgroundColor: string = "rgb(5, 102, 141)";
export const cardBorderColor: string = "rgba(217, 217, 217, 0.55)";
